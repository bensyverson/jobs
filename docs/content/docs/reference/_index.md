...
{{< cards >}}
  {{< card link="setup" title="Setup" subtitle="`init`, `gitignore`, `identity`, `schema`, `merge` — bring a database into existence, decide who writes to it, and reconcile two copies." >}}
